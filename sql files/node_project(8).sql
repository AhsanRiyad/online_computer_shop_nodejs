...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2019 at 08:50 PM
...
CREATE TABLE `order_t` (
  ...
  `counter` int(8) NOT NULL,
  `seller_id` int(8) NOT NULL DEFAULT '0',
...
INSERT INTO `order_t` (`order_id`, `order_date`, `payment_method`, `payment_status`, `return_id`, `user_id`, `counter`, `seller_id`, `product_name`) VALUES
(2, '0000-00-00', 'cash', 'payed', 2, 0, 1, 2, 'applae'),
(3, '2019-03-01', 'online', 'cash on delivery', 3, 0, 2, 2, 'acer'),
(4, '0000-00-00', 'cash', 'payed', 4, 0, 3, 2, 'hp'),
(1, '2019-03-01', 'online', 'cash on delivery', 1, 0, 4, 2, 'samsung'),
(2, '0000-00-00', 'cash', 'payed', 2, 0, 5, 2, 'applae'),
(3, '2019-03-01', 'online', 'cash on delivery', 3, 0, 6, 2, 'acer'),
(4, '0000-00-00', 'cash', 'payed', 4, 0, 7, 2, 'hp'),
(1, '2019-03-01', 'online', 'cash on delivery', 1, 0, 8, 2, 'samsung');
...
(2, '12', 'default', 'riyad298@gmail.com', 1919448787, '2007-02-17', 'valid', 'admin', 'Muhammad Ahsan', 'Riyad'),
(4, 'fff', 'default', 'ffffaaa', 666, '2007-02-14', 'valid', 'user', 'Muhammad Ahsan', 'afa'),
(12, 'afrf', 'default', 'riyadarfr298@gmail.com', 1919448787, '2007-03-15', 'valid', 'user', 'Muhammad Ahsan', 'Riyad'),
(14, 'arefa', 'default', 'riyadhellow298@gmail.com', 1919448787, '0000-00-00', 'valid', 'user', 'Muhammad Ahsan', 'Riyad'),
(15, '448787', 'default', 'riyad298@outlook.com', 1919448787, '0000-00-00', 'valid', 'user', 'Ahsan', 'Riyad'),
(16, 'afaaf', 'default', 'afa343', 122, '0000-00-00', 'valid', 'user', 'riyad', 'afa'),
(18, '12', 'default', 'aa', 111, '0000-00-00', 'seller', 'seller', 'riyad', 'afa'),
(19, '111', 'default', 'riyad28877722@gmail.com', 1919448787, '0000-00-00', 'valid', 'admin', 'sde', 'edf');
...
--
ALTER TABLE `order_t`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `visit`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
