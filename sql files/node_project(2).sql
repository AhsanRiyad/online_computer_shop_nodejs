...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2019 at 04:24 AM
...
(4, 'riyad', '0000-00-00', 3, '3', 34, 32, 0);
...
(2, '12', '', 'riyad298@gmail.com', 1919448787, '2007-02-17', 'valid', 'user', 'Muhammad Ahsan', 'Riyad'),
...
--
ALTER TABLE `g_user_name`
  MODIFY `counter` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `promo`
  MODIFY `promo_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
